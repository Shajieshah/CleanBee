...
puts "Create Vendors and Shops"

Vendor.create!(email: 'vendor1@example.com', password: 'password', password_confirmation: 'password')
Vendor.first.create_shop(name: 'Doha Festival City Mall', description: 'Do the stuff with innovation in daily life!', timings: '', latitude: 31.520370, longitude: 74.358749)
...
Vendor.third.create_shop(name: 'Mall of Qatar ', description: 'do the stuff with innovation in daily life!', timings: '', latitude: 31.520370, longitude: 74.358749)

Vendor.create!(email: 'alie.ammaar@gmail.com', password: 'password', password_confirmation: 'password')
Vendor.fourth.create_shop(name: 'Lagoona Mall ', description: 'do the stuff with innovation in daily life!', timings: '', latitude: 31.520370, longitude: 74.358749)
...
@order = Order.create(user_id:1, shop_id:1, order_type:"regular", pick_location: "Villaggio Mall, Luxury Extension Doha Qatar, Qatar", pickup_time: "12:12:12",
                      pickup_date: "12-12-12", delivery_time: "12:12:12", delivery_date: "12-12-12",
                      status: "pending", cost: 30, pick_lat: "72.22", pick_lng: "72.12")
...
@order = Order.create(user_id:1, shop_id:1, order_type:"regular", pick_location: "Villaggio Mall, Luxury Extension Doha Qatar, Qatar", pickup_time: "12:12:12",
                      pickup_date: "12-12-12", delivery_time: "12:12:12", delivery_date: "12-12-12",
                      status: "open", cost: 30, pick_lat: "72.22", pick_lng: "72.12")
@laudries = @order.order_laundries.create(order_id: @order.id, laundry_id: 1, cost: 30, notes: "Wash it clearly")
@laudries.laundry.laundry_capabilities.create(capability_id: 1)
...
@order = Order.create(user_id:1, shop_id:1, order_type:"regular", pick_location: "Villaggio Mall, Luxury Extension Doha Qatar, Qatar", pickup_time: "12:12:12",
                      pickup_date: "12-12-12", delivery_time: "12:12:12", delivery_date: "12-12-12",
                      status: "processing", cost: 30, pick_lat: "72.22", pick_lng: "72.12")
@laudries = @order.order_laundries.create(order_id: @order.id, laundry_id: 1, cost: 30, notes: "Wash it clearly")
@laudries.laundry.laundry_capabilities.create(capability_id: 1)
...
@order = Order.create(user_id:1, shop_id:1, order_type:"regular", pick_location: "Villaggio Mall, Luxury Extension Doha Qatar, Qatar", pickup_time: "12:12:12",
                      pickup_date: "12-12-12", delivery_time: "12:12:12", delivery_date: "12-12-12",
                      status: "completed", cost: 30, pick_lat: "72.22", pick_lng: "72.12")
@laudries = @order.order_laundries.create(order_id: @order.id, laundry_id: 1, cost: 30, notes: "Wash it clearly")
@laudries.laundry.laundry_capabilities.create(capability_id: 1)
